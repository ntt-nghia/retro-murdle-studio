    ...
    <div className="space-y-4">
      ...
      <div className="retro-frame" data-tutorial="navigation-panel">
        ...
        <div className="grid grid-cols-3 gap-2 p-2">
          <Button className="retro-button !text-xs" onClick={() => onOpenModal('suspects')}><Users
            className="mr-2 h-4 w-4"/>SUSPECTS</Button>
          <Button className="retro-button !text-xs" onClick={() => onOpenModal('weapons')}><Microscope
            className="mr-2 h-4 w-4"/>WEAPONS</Button>
          <Button className="retro-button !text-xs" onClick={() => onOpenModal('locations')}><MapPin
            className="mr-2 h-4 w-4"/>LOCATIONS</Button>
        </div>
      </div>
